	...
	return (
		<div className="space-y-[var(--space-md)]">
			...
			<select
				...
				className="w-full h-[calc(var(--space-2xl)+var(--space-md))] px-[var(--space-md)] text-[12px] font-medium rounded-md border border-ctp-surface0/40 bg-ctp-mantle/40 text-ctp-subtext1 outline-none cursor-pointer transition-all duration-[180ms] hover:border-ctp-surface1/50 focus-visible:border-ctp-lavender/45 focus-visible:shadow-[0_0_0_1px_inset,0_0_0_3px] focus-visible:shadow-ctp-lavender/15"
			>
			...
			<p className="text-[10px] text-ctp-overlay0/70 leading-relaxed">
				Use <code className="text-ctp-lavender/60 font-mono text-[10px]">{"{{variable}}"}</code>{" "}
